    ...
    <Card className="overflow-hidden rounded-3xl shadow-sm">
      ...
      <CardContent className="p-8 flex justify-center items-center">
        <button
          ...
          className="relative w-[100px] sm:w-[140px] md:w-[180px] h-[36px] sm:h-[50px] md:h-[60px] rounded-full bg-gray-200 border-2 border-gray-300 shadow-inner focus:outline-none"
          aria-pressed={isOn}
          role="switch"
        >
          <div
  ...
  return (
    <Card className="overflow-hidden rounded-3xl shadow-sm">
      ...
      <CardContent className="p-8 flex justify-center items-center">
        <button
          onClick={handleToggle}
          className="relative w-[60px] sm:w-[80px] md:w-[100px] h-[28px] sm:h-[40px] md:h-[50px] bg-gray-100 border border-gray-300 rounded-sm focus:outline-none overflow-hidden"
          aria-pressed={isOn}
          role="switch"
        >
...
export function DeviceControls({ roomId }: DeviceControlsProps) {
  ...
  return (
    <div className="w-full grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 px-2 sm:px-4 overflow-x-auto overflow-y-hidden max-w-full">
